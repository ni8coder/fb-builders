      ...
      <div class="modal-body addBody">
        <form id="basicForm" action="" method="post" class="form-horizontal">
                ...
                <div class="form-group">
                  <label class="col-sm-3 control-label">Property Type<span class="text-danger">*</span></label>
                  <div class="col-sm-8">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <textarea rows="5" class="form-control" name="notes" placeholder="Comments" ></textarea>
                  </div>
                </div>
    ...
    <div class="contentpanel">
      ...
      <div class="panel">
        <div class="panel-heading">
          <h4 class="panel-title">Fbuilders Properties</h4>
           <div align="right"><button class="btn btn-primary" data-toggle="modal" data-target="#addModal">Add Property</button></div>
        </div>
