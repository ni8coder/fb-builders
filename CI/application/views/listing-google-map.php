...
<body>
    ...
    <section class="real_area real_area_nospace">
        <div class="widget real_widget_map real_style_04">
            <div class="real_map">                
            </div>
        </div>
    </section>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="real_breadcrumd real_style_03">
                            <div class="row">
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    <span>Listing</span>
                                </div>
                ...
                <div class="row real_full_col_979">
                    ...
                    <div class="col-md-4 col-sm-5">
                        <div class="real_sidebar_right">
                            ...
                            <aside class="widget widget_epl_property_search real_style_04" id="epl_property_search-5">
