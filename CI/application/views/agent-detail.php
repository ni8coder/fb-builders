...
<body>
    ...
    <div id="main_content">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="real_breadcrumd real_style_02">
                            <div class="row">
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    <span>Author archives: Julia Robert</span>
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                        ...
                                        <div class="breadcrumb_nav">
                                            ...
                                            <span itemtype="http://data-vocabulary.org/Breadcrumb" itemscope="">
                                                <a itemprop="url" class="current-page">
                                                    <span itemprop="title">Block list</span>
                                                </a>
                                            </span>
                                        </div>
                                    </div>
        ...
        <section class="real_area real_area_00">
            <div class="container">
                <div class="row real_full_col_800">
                    <div class="col-md-8 col-sm-7 col-xs-12">
                        <div class="widget real_widget_has_pagi_many_pro">
                            <div class="widget-content">
                                <article class="entry-item real_style_01">
                                    <div class="entry-thumb">
                                        <img src="http://placehold.it/236x148" alt="">
                                    </div>
                                    <div class="entry-content">
                                        <h3 class="entry-title">LISTING PHOTOS IN WIDGET</h3>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed vitae nisi eu felis viverra vulputate. Cras malesuada felis magna, sit amet vestibulum risus ultricies at. Nullam ultrices erat in mauris varius, ac dapibus ante bibendum. Sed rutrum neque id faucibus elementum. Vestibulum in neque risus. Nulla facilisi. Maecenas scelerisque interdum mi, eu elementum ante pharetra ac. Aliquam vitae pulvinar sapien. Sed consequat placerat amet est ut elementum. Donec at venenatis justo. Etiam sed massa sapien. Nullam sodales fermentum lobortis. Morbi cursus luctus risus. Cras ac auctor sapien. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis lobortis enim non elit tristique, non pretium enim tempus. Vestibulum eleifend sit amet elit ac blandit. Fusce </p>
                                    </div>
                                </article>
                                <article class="entry-item">
                                    <div class="entry-thumb">
                                        <img src="http://placehold.it/769x487" alt="">
                                    </div>
                                    <div class="entry-content">
                                        <h4 class="entry-title">15421 Southwest 39th Terrace</h4>
                                        <a href="#" class="real_button real_style_01">Leave a reply</a>
                                        <p class="entry-detail">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed vitae nisi eu felis viverra vulputate. Cras malesuada felis magna, sit amet vestibulum risus ultricies at. Nullam ultrices erat in mauris varius, ac dapibus ante bibendum. Sed rutrum neque id faucibus elementum. Vestibulum in neque risus. Nulla facilisi. Maecenas scelerisque interdum mi, eu elementum ante pharetra ac. Aliquam vitae pulvinar sapien. Sed consequat placerat sollicitudin. Sed semper adipiscing rhoncus. Aliquam ac vestibulum risus, ut iaculis elit. Fusce tristique sit amet est ut elementum.</p>
                                        <p class="entry-detail">Donec at venenatis justo. Etiam sed massa sapien. Nullam sodales fermentum lobortis. Morbi cursus luctus risus. Cras ac auctor sapien. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis lobortis enim non elit tristique, non pretium enim tempus.</p>
                                        <div class="meta_data">
                                            <span>This entry was posted on <a href="#">June 5, 2015.</a></span>
                                        </div>
                                    </div>
                                </article>
                                <article class="entry-item">
                                ...
                                <div class="paginator real_style_01">
                                    <nav class="navigation pagination" role="navigation">
                                        <h2 class="screen-reader-text">Posts navigation</h2>
                                        <div class="nav-links">
                                            <a class="prev page-numbers" href="#">  
                                                <img src="http://placehold.it/10x8" alt="">
                                                older posts
                                            </a>
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <div class="real_sidebar_right">
                            ...
                            <aside id="epl_recent_property-5" class="widget widget_epl_recent_property"><h3 class="widget-title">Featured Listing</h3><div class="epl-property-widget-image-wrapper">
                                <div id="post-162" class="epl-widget epl-listing-widget property-widget-image epl-widget-status-current">
