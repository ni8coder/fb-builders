...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="widget real_widget_has_img_map_side">
                        <div class="widget-title real_style_07">
                            <h3 class="real_style_07">Properties Listing</h3>
    ...
    <div id="main_content">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    <div class="real_breadcrumb real_style_01">
                                        ...
                                        <div class="breadcrumb_nav">
                                            ...
                                            <span itemtype="http://data-vocabulary.org/Breadcrumb" itemscope="">
                                                <a itemprop="url" href="#">
                                                    <span itemprop="title">Blog list</span>
                                                </a>
                                            </span>
        ...
        <section class="real_area real_area_12">
            <div class="container">
                <div class="row real_full_col_979">
                    <div class="col-md-8 col-sm-7 col-xs-12">
                        <div class="epl-archive-default">
                                        ...
                                        <div class="epl-archive-entry-image">
                                            <a href="#">
                                                <div class="epl-blog-image">
                                                    ...
                                                    <img src="http://placehold.it/293x233" alt="">
                                                </div>
                                            </a>
                                        </div>
                                        <!-- Home Open -->
                                        ...
                                        <div class="epl-archive-entry-image">
                                            <a href="#">
                                                <div class="epl-blog-image">
                                                    ...
                                                    <img src="http://placehold.it/294x234" alt="">
                                                </div>
                                            </a>
                                        </div>
                                        <!-- Home Open -->
                            ...
                            <!-- Previous/Next page navigation -->
                                <div class="loop-utility clearfix">
                                    <div class="epl-pagination">
                                        ...
                                        <a class="previouspostslink" rel="prev" href="#"><i class="fa fa-chevron-left"></i>
                                        </a>
                                        <a class="page larger" href="#">1</a>
                                        <span class="current">2</span>
                                        <a class="page larger" href="#">3</a>
                                        <a class="nextpostslink" rel="next" href="#"><i class="fa fa-chevron-right"></i>
                                        </a>
                                    </div>
                                </div>
                            </div>
