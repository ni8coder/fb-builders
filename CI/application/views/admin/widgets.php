        ...
        <nav class="navbar navbar-inverse">
          ...
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#"><h3>Quirk</h3></a>
          </div>
        ...
        <div class="row demo-navwrapper">
          ...
          <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
            <div class="nav-wrapper quirk">
              <h5 class="sidebar-title">Navigation</h5>
              <ul class="nav nav-pills nav-stacked nav-quirk nav-dark-quirk">
                <li><a href="#"><i class="fa fa-home"></i> <span>Home</span></a></li>
                <li class="nav-parent active">
                  <a href=""><i class="fa fa-star"></i> <span>Features</span></a>
                  <ul class="children">
          ...
          <div class="col-sm-4 col-md-3 col-lg-2">
            <div class="nav-wrapper quirk">
              <h5 class="sidebar-title">Navigation</h5>
              <ul class="nav nav-pills nav-stacked nav-quirk nav-dark-primary">
                <li><a href="#"><i class="fa fa-home"></i> <span>Home</span></a></li>
                <li class="nav-parent active">
                  <a href=""><i class="fa fa-star"></i> <span>Features</span></a>
                  <ul class="children">
          ...
          <div class="col-sm-4 col-md-3 col-lg-2">
            <div class="nav-wrapper quirk">
              <h5 class="sidebar-title">Navigation</h5>
              <ul class="nav nav-pills nav-stacked nav-quirk nav-dark-danger">
                <li><a href="#"><i class="fa fa-home"></i> <span>Home</span></a></li>
                <li class="nav-parent active">
                  <a href=""><i class="fa fa-star"></i> <span>Features</span></a>
                  <ul class="children">
          ...
          <div class="col-sm-4 col-md-3 col-lg-2">
            <div class="profile-left mb20">
              <div class="profile-left-heading">
                ...
                <a class="profile-photo" href=""><img alt="" src="<?php echo base_url(); ?>includes/admin/images/photos/profilepic.png" class="img-circle img-responsive"></a>
          ...
          <div class="col-sm-4 col-md-6 col-lg-4">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="panel">
                  ...
                  <div class="panel-body">
                    <button class="btn btn-primary btn-stroke btn-icon tooltips mr5" data-toggle="toggle" title="Facebook"><i class="fa fa-facebook"></i></button>
                    <button class="btn btn-info btn-stroke btn-icon tooltips mr5" data-toggle="toggle" title="Twitter"><i class="fa fa-twitter"></i></button>
                    <button class="btn btn-danger btn-stroke btn-icon tooltips mr5" data-toggle="toggle" title="Google Plus"><i class="fa fa-google-plus"></i></button>
                    <button class="btn btn-primary btn-stroke btn-icon tooltips" data-toggle="toggle" title="Linkedin"><i class="fa fa-linkedin"></i></button>
                  </div>
                </div>
              </div>
            ...
            <div class="panel panel-primary-full">
              <div class="panel-heading">
                ...
                <p>Sign up to get an updates to our awesome community using our personalized newsletter!</p>
              </div>
              <div class="panel-body">
                <div class="input-group">
                  <input type="text" class="form-control" placeholder="Please enter your email address">
                  <span class="input-group-btn">
                    <button class="btn btn-default btn-quirk btn-warning" type="button">Subscribe</button>
                  </span>
                </div>
              </div>
            </div>
            ...
            <div class="panel panel-success-full">
              <div class="panel-heading">
                <h4 class="panel-title">Our Top Story</h4>
              </div>
              <div class="panel-body">
                <h4 class="mt0">Two Good Reasons to Love Quirk</h4>
                ...
                <ul class="list-inline nomargin">
                  ...
                  <li><a href="">2 Shares</a></li>
                  <li><a href="">1,202 Views</a></li>
                </ul>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="panel panel-primary-full">
                  <div class="panel-heading">
                    <h4 class="panel-title">Attractive</h4>
                  </div>
                  <div class="panel-body">
                    <p>When your website or app is attractive to use, your users will not simply be using it, they’ll look forward to using it.</p>
                    <p>This means that you should fashion the look and feel of your interface for your users.</p>
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="panel panel-danger-full">
                  <div class="panel-heading">
                    <h4 class="panel-title">Responsive</h4>
                  </div>
                  <div class="panel-body">
                    <p>Responsive Web design is the approach that suggests that design and development should...</p>
                    <p>This would eliminate the need for a different design and development phase for each...</p>
                  </div>
                </div>
              </div>
            </div><!-- row -->
        ...
        <div class="row">
          <div class="col-sm-4 col-lg-3">
            <div id="datepicker-inline" class="calendar-widget"></div>
          </div>
          <div class="col-sm-4 col-lg-3">
          ...
          <div class="col-sm-4 col-lg-3 gritter-demo">
            <div role="alert" class="gritter-item-wrapper with-icon send-o success mb10">
              <div class="gritter-item">
                <div class="gritter-without-image">
                  <span class="gritter-title">Your reply has been sent!</span>
                  <p>A new rating has been received for Quirk...</p>
                </div>
                <div style="clear:both"></div>
              </div>
            </div><!-- gritter-item-wrapper -->
            <div role="alert" style="" class="gritter-item-wrapper with-icon exclamation-circle send-o warning mb10">
              <div class="gritter-item">
                <div class="gritter-without-image">
                  <span class="gritter-title">This is a warning message!</span>
                  <p>Having a class name warning applied to it.</p>
                </div>
                <div style="clear:both"></div>
              </div>
            </div><!-- gritter-item-wrapper -->
            <div role="alert" style="" class="gritter-item-wrapper with-icon times-circle danger">
              <div class="gritter-item">
                <div class="gritter-without-image">
                  <span class="gritter-title">This is an error message!</span>
                  <p>Having a class name danger applied to it.</p>
                </div>
                <div style="clear:both"></div>
              </div>
            </div><!-- gritter-item-wrapper -->
        ...
        <div class="row">
          <div class="col-sm-4 col-lg-3">
            <div class="panel-group panel-product" id="accordion3">
                ...
                <div id="collapseOne3" class="panel-collapse collapse in">
                  <div class="panel-body">
                    <div class="media">
                      <div class="media-left">
                        <a href="#">
                          <img class="media-object width80" src="<?php echo base_url(); ?>includes/admin/images/image.png" alt="">
                        </a>
                      </div>
                      <div class="media-body">
                        <h4 class="media-heading"><a href="">PSD Premium UI Kit</a></h4>
                        <p>20 PSD Files, 10 AI Files, 10 Sketch Files, Documentation and much more...
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div id="collapseThree3" class="panel-collapse collapse">
                  <div class="panel-body">
                    <table class="table nomargin">
                      <tbody>
                        <tr>
                          <th>Photoshop Plugins:</th>
                          <td>2</td>
                        </tr>
                        <tr>
                          <th>Photoshop Actions</th>
                          <td>4</td>
                        </tr>
                        <tr>
                          <th>Wireframes:</th>
            ...
            <div class="panel-group panel-product" id="accordion2">
              <div class="panel panel-inverse">
                ...
                <div id="collapseOne2" class="panel-collapse collapse in">
                  <div class="panel-body">
                    <img src="<?php echo base_url(); ?>includes/admin/images/logo.png" alt="" class="mb10">
                    <p>When it comes to websites or apps, one of the first impression you consider is the design...<a href="">Read more</a></p>
                  </div>
                </div>
              </div>
              <div class="panel panel-inverse">
                  ...
                  <div class="panel-body">
                    <ul class="list-group nomargin">
                      <li class="list-group-item">
                        <h5>PSD to HTML5/CSS3</h5>
                        <p>Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit...<a href="">Learn more</a></p>
                      </li>
                    </ul>
                  </div>
                </div>
          ...
          <div class="col-sm-4 col-lg-3">
            <div class="panel-group panel-product" id="accordion1">
              ...
              <div class="panel panel-info">
                <div class="panel-heading">
                  <h4 class="panel-title">
                    <a data-toggle="collapse" class="collapsed" data-parent="#accordion1" href="#collapseTwo1">
                      Trending Story
                    </a>
                  </h4>
                </div>
              ...
              <div class="panel panel-info">
                <div class="panel-heading">
                  <h4 class="panel-title">
                    <a data-toggle="collapse" class="collapsed" data-parent="#accordion1" href="#collapseThree1">
                      Recent Story
                    </a>
                  </h4>
                </div>
        ...
        <div class="row">
          <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="panel signin signin-demo">
              <div class="panel-heading">
                <img class="center-block" src="<?php echo base_url(); ?>includes/admin/images/logo-big.png" alt="">
          ...
          <div class="col-sm-6 col-md-8 col-lg-6">
            <div class="panel">
              <div class="panel-heading">
                <h4 class="panel-title">Primary Colored Table</h4>
                <p>Add <code>.table-primary</code> for a primary colored table.</p>
              </div>
              <div class="panel-body">
            ...
            <div class="well primary mb10">
              <h3>Announcements</h3>
              <p>A brand new wallpaper design contest is now live! See what theme you'll be challenged with this month!</p>
            </div>
            <div class="well warning">
              <h3>Mobile Friendly Comments Dashboard</h3>
              <p>A responsive, mobile friendly version of the comments dashboard is now available to.</p>
            </div>
          </div>
        </div><!-- row -->
        ...
        <div class="row">
          <div class="col-md-8 col-lg-6">
            <div class="row blog-entry mb20">
              <div class="col-sm-5">
                <h6 class="blog-category">Design &amp; Illustration</h6>
                <h3 class="blog-title"><a href="">30 Awesome Photo Effect Tutorials</a></h3>
                <p class="blog-meta mb20">By: <a href="">Grant Friedman</a> &nbsp; Aug 27, 2013 &nbsp;</p>
                <p class="blog-summary mb20">Photoshop is clearly our favorite photo editing software. In this article, we have listed 30 photo effect tutorials that will show you how to perform a wide range... <a href="http://goo.gl/NThVZj" target="_blank">Read more</a></p>
                <p><a href="">9 Comments</a> &nbsp; <a href="">10 Shares</a></p>
              </div>
              <div class="col-sm-7">
                <img class="img-responsive" src="<?php echo base_url(); ?>includes/admin/images/photos/photo1.jpg" alt="">
              </div>
            </div>
          ...
          <div class="col-md-4 col-lg-3">
            <div class="blog-entry2">
              <div class="blog-img">
                <img class="img-responsive" src="<?php echo base_url(); ?>includes/admin/images/photos/photo2.jpg" alt="">
              </div>
              <div class="blog-body">
                <h6 class="blog-category">Design &amp; Illustration</h6>
                <h3 class="blog-title"><a href="">30 Awesome Photo Effect Tutorials</a></h3>
                <p class="blog-meta mb20">By: <a href="">Grant Friedman</a> &nbsp; Aug 27, 2013 &nbsp;</p>
                <p class="blog-summary mb20">Photoshop is clearly our favorite photo editing software. In this article, we have listed 30 photo effect tutorials that will show you how to... <a href="http://goo.gl/NThVZj" target="_blank">Read more</a></p>
                <p class="nomargin"><a href="">9 Comments</a> &nbsp; <a href="">10 Shares</a></p>
              </div>
            </div>
          </div>
        </div>
