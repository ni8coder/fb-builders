          ...
          <div class="row filemanager">
            ...
            <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2 audio">
              <div class="thmb">
                ...
                <div class="thmb-prev">
                  <img src="<?php echo base_url(); ?>includes/admin/images/mp3.png" class="img-responsive" alt="" />
                </div>
            ...
            <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2 document">
              <div class="thmb">
                ...
                <div class="thmb-prev">
                  <img src="<?php echo base_url(); ?>includes/admin/images/doc.png" class="img-responsive" alt="" />
                </div>
            ...
            <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2 image">
              <div class="thmb">
                ...
                <div class="thmb-prev">
                  <a href="">
                    <img src="<?php echo base_url(); ?>includes/admin/images/png.png" class="img-responsive" alt="" />
                  </a>
                </div>
            ...
            <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2 video">
              <div class="thmb">
                ...
                <div class="thmb-prev">
                  <img src="<?php echo base_url(); ?>includes/admin/images/mp4.png" class="img-responsive" alt="" />
                </div>
            ...
            <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2 document">
              <div class="thmb">
                ...
                <div class="thmb-prev">
                  <img src="<?php echo base_url(); ?>includes/admin/images/docx.png" class="img-responsive" alt="" />
                </div>
