	...
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
			<h2 class="text-center">Edit Investor</h2>
			<br><br>
		<form method="post" action="<?php echo base_url(); ?>user_management/investor/update_data/<?php echo $edit_data->id; ?>" class="form-horizontal" pmbx_context="656015A6-0CC3-416A-8981-2ACD5F993540">
