...
<script src="<?php echo base_url(); ?>includes/admin/lib/flot/jquery.flot.symbol.js"></script>
<script src="<?php echo base_url(); ?>includes/admin/lib/flot/jquery.flot.crosshair.js"></script>
<script src="<?php echo base_url(); ?>includes/admin/lib/flot/jquery.flot.categories.js"></script>
<script src="<?php echo base_url(); ?>includes/admin/lib/flot/jquery.flot.pie.js"></script>
...
<script src="<?php echo base_url(); ?>includes/admin/lib/jquery-sparkline/jquery.sparkline.js"></script>

<script src="<?php echo base_url(); ?>includes/admin/js/quirk.js"></script>
<script src="<?php echo base_url(); ?>includes/admin/js/charts.js"></script>
