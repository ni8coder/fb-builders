	...
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
			...
			<br><br>
		<form method="post" action="<?php echo base_url(); ?>/user_management/customer/update_data/<?php echo $edit_data->id; ?>" class="form-horizontal" pmbx_context="656015A6-0CC3-416A-8981-2ACD5F993540">
			
			<label class="col-sm-3 control-label">MR No<span class="text-danger">*</span></label>
			<div class="col-sm-8">
                <input type="text" name="mr_no" value="<?php echo $edit_data->mr_no?>" class="form-control"">
            </div>
