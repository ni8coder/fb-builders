      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="panel">
              ...
              <div class="panel-body nopaddingtop">
                ...
                <form id="basicForm3" class="form-horizontal" action="form-validation.html">
        ...
        <div class="col-md-6">
          <div class="panel">
              ...
              <div class="panel-body nopaddingtop">
                <hr>
                <form id="basicForm4" class="form-horizontal" action="form-validation.html">
                  <div class="form-group">
...
<script src="<?php echo base_url(); ?>includes/admin/lib/jquery-validate/jquery.validate.js"></script>
