...
<body>
    <header class="real_header real_style_01">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <div class="real_header_top_right">
                                <ul class="real_acount">                                    
                                    <li><a href="#">log in<i class="fa fa-unlock-alt"></i></a></li>
                                    <li><a href="#">Sing up<i class="fa fa-pencil"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row row_custom_01">
                    <div class="col-md-3 col-sm-4 col-xs-6 col_custom_left">
                        <div class="real_logo_header">
                            <a href="#"><img src="http://placehold.it/238x58" alt=""></a>
                        </div>
                    </div>
                    <div class="col-md-9 col-sm-8 col-xs-6 col_custom_right">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="real_header_middle_right">
                                        ...
                                        <ul class="real_social real_style_03">
                                            <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                                            <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                                            <li><a href="#"><i class="fa fa-youtube-play"></i></a></li>
                                            <li><a href="#"><i class="fa fa-instagram"></i></a></li>
                                        </ul>
                                        <div class="real_cart_shop">
                                            <a href="#">
                                                <span class="real_price">$0.00</span>
                        ...
                        <div class="real_header_bottom">
                            <div class="row">
                                <div class="col-md-10 col-sm-10 real_has_custom">
                                ...
                                <div class="col-md-2 col-sm-2">
                                    <div class="real_search_plus_menubar">
                                        <div class="row">
                                            <div class="col-md-8">
    ...
    <!-- end menu k -->
    <section class="real_area real_has_img_bg_03">
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="widget real_widget_has_images_map_side">
                        <div class="widget-title real_style_07">
                            <h3 class="real_style_07">Properties detail</h3>
    ...
    <div id="main_content">
        ...
        <section class="real_area real_area_10">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="real_breadcrumd real_style_02">
                            <div class="row">
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    <span>Properties detail</span>
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    <div class="real_breadcrumb real_style_01">
                                        ...
                                        <div class="breadcrumb_nav">
                                            ...
                                            <span itemtype="http://data-vocabulary.org/Breadcrumb" itemscope="">
                                                <a itemprop="url" href="#">
                                                    <span itemprop="title">Properties list</span>
                                                </a>
                                            </span>
                                            
                                            <span itemtype="http://data-vocabulary.org/Breadcrumb" itemscope="">
                                                <a itemprop="url" class="current-page">
                                                    <span itemprop="title">Properties detail</span>
                                                </a>
                                            </span>
                                        </div>
                                    </div>
        ...
        <section class="real_area real_area_00">
            <div class="container">
                <div class="row real_full_col_979">
                                ...
                                <div class="title-meta-wrapper">
                                    <div class="entry-col property-details">
                                        <h2 class="entry-title">
                                            <span class="item-street">6020 Southwest 39th Terrace</span>
                                            <span class="entry-title-sub">
                                                <span class="item-suburb">Sorrento</span>
                                                <span class="item-seperator">,</span>
                                                <span class="item-state">WA</span>
                                                <span class="item-pcode">6020</span>
                                            </span>
                                        </h2>
                                    </div>
                                    <div class="entry-col property-pricing-details">
                                        <div class="property-meta pricing">
                                            <span class="page-price">From $1,500,000</span>
                                        </div>
                                        <div class="property-feature-icons epl-clearfix">
                                            <span title="Bedrooms" class="icon beds"><span class="icon-value">5</span></span>
                                            <span title="Bathrooms" class="icon bath"><span class="icon-value">3</span></span>
                                            <span title="Parking Spaces" class="icon parking"><span class="icon-value">5</span></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="entry-content epl-content epl-clearfix">
                                <div class="entry-image">
                                    <div class="epl-featured-image it-featured-image">
                                        <a href="#"><img src="http://placehold.it/769x487" class="index-thumbnail wp-post-image" alt=""> </a>
                                    </div>
                                </div>
                                ...
                                <div class="tab-wrapper">
                                        ...
                                        <div class="tab-content">
                                            <div class="property-details">
                                                <h3 class="tab-address">
                                                    <span class="item-street">15421 Southwest 39th Terrace</span>
                                                </h3>
                                                <span class="page-price">From $1,500,000</span> </div>
                                    ...
                                    <div class="epl-tab-section epl-section-description">
                                        ...
                                        <div class="tab-content">
                                            <!-- heading -->
                                            <h2 class="entry-title">15421 Southwest 39th Terrace</h2>
                                            
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse placerat, lacus at pulvinar pharetra, sem metus pulvinar leo, ut adipiscing velit ipsum vel dui. Nam volutpat lacinia viverra. Proin tristique tortor sit amet viverra scelerisque. Vivamus convallis varius massa id dictum. Sed facilisis massa turpis, ut dictum leo laoreet nec. Nam ac scelerisque sapien, eu laoreet justo. Cras vel tristique nunc. Nulla risus mi, laoreet eu commodo at, faucibus sed diam. Vivamus ac augue lacinia, aliquam urna nec, accumsan ante. Pellentesque rutrum massa ut augue gravida, et feugiat diam fringilla. Ut rhoncus pulvinar mi a ultrices. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae;</p>
                                            <p>Duis at urna ac nulla vestibulum pellentesque vel quis odio. Duis suscipit, dui et auctor pellentesque, nisl justo egestas libero, quis tempor libero enim sed nunc. Donec dapibus mollis nibh sit amet vulputate. Pellentesque pretium id ante eu sagittis. Fusce lobortis placerat ipsum, at eleifend erat rutrum ut. Integer tempor mi viverra augue rhoncus rhoncus. Phasellus varius urna a imperdiet pulvinar. Fusce ultricies diam ligula, quis dapibus nisl congue ullamcorper. Proin at luctus nisi.</p>
                                            <div class="epl-video-container videoContainer">
                                                <iframe src="https://www.youtube.com/embed/YQYQclhnigQ?feature=oembed" height="338" width="600"></iframe>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="epl-tab-section epl-tab-section-features">
                                        ...
                                        <div class="epl-tab-content tab-content">
                                            <ul class="listing-info epl-tab-3-columns">
                                                <li class="bedrooms">5 bed</li>
                                                <li class="bathrooms">3 bath</li>
                                                <li class="parking">4 Parking Spaces</li>
                                                <li class="land-size">Land is 875 sqm</li>
                                                <li class="garage">4 Garage</li>
                                                <li class="category">House</li>
                                                <li><a href="#" rel="tag">Air Conditioning</a></li>
                                                <li><a href="#" rel="tag">Close to School</a></li>
                                                <li><a href="#" rel="tag">Lots of Windows</a></li>
                                                <li><a href="#" rel="tag">Outdoor Entertaining Area</a></li>
                                                <li><a href="#">Open Fire Place</a></li>
                                                <li>Near the Mall</li>
                                            </ul>
                                        </div>
                                    ...
                                    <div class="epl-gallery-entry entry-gallery epl-clearfix">
                                        ...
                                        <div class="gallery galleryid-302 gallery-columns-5 gallery-size-thumbnail">

                                            <div class="gallery-item">
                                                
                                                    <a class="fancybox image" href="#"><img src="http://placehold.it/138x138" class="attachment-thumbnail" alt="Ashmore9-1">
                                                    </a>
                                    ...
                                    <div id="epl-advanced-map-single" class="epl-advanced-map-single epl_tabbed_maps_wrapper epl-am-infobox- epl-clearfix">
                                        ...
                                        <div class="epl_tabbed_map_control">
                                            <ul class="epl_adv_map_list map-tabs">
                                                <li class="current maptab-current" data-map="sat">Satellite</li>
                                                <li class="" data-map="transit">Transit</li>
                                                <li class="" data-map="bike">Bike</li>
                                                <li class="" data-map="comparables">Comparables</li>
                                            </ul>
                                        </div>
                                    ...
                                    <div class="epl-author-box-container">
                                        <h5 class="tab-title">out gent</h5>
                                        <ul class="epl-author-tabs author-tabs">
                                            <li class="tab-link epl-author-current" data-tab="tab-1">About</li>             
                                            <li class="tab-link" data-tab="tab-2">Bio</li>
                                            <li class="tab-link" data-tab="tab-3">Contact</li>
                                            <li class="tab-link" data-tab="tab-4">Video</li>
                                        </ul>
                                        <div class="epl-author-box-outer-wrapper author-box-outer-wrapper epl-clearfix">
                                            <div class="epl-author-box epl-author-image author-box author-image">
                                                <img alt="" src="http://placehold.it/151x151" class="avatar avatar-150 photo">
                                            </div>
                                            <div id="tab-1" class="epl-author-author_id epl-author-tab-content epl-author-box author-box epl-author-current">
                                                <div class="epl-author-contact-details author-contact-details">
                                                    <h5 class="epl-author-title author-title">
                                                        <a href="#">Agent Julia Robert</a>
                                                    </h5>
                                                    <div class="epl-author-position author-position">
                                                        <span class="label-position"></span>
                                                        <span class="position">Real Estate Group</span>
                                                    </div>
                                                    <div class="epl-author-contact author-contact">
                                                        <span class="label-mobile"></span>
                                                        <span class="mobile">44 (0) 800 765 1234</span>
                                                    </div>
                                                ...
                                                <div class="epl-author-slogan author-slogan">Markus is a Certified Residential Specialist with 
                                                over 10 years experience of helping local residents sell homes. He achieved success due to his commitment to the enhancement of the real estate profession, client service, and the community</div>
                                            ...
                                            <div id="tab-2" class="epl-author-description epl-author-tab-content epl-author-box author-box">
                                                <div class="epl-author-content author-content">Markus is a Certified Residential Specialist with 
                                                over 10 years experience of helping local residents sell homes. He achieved success due to his commitment to the enhancement of the real estate profession, client service, and the community</div>
                                                <span class="bio-more">
                                                    <a href="#">Read More</a>
                                                </span>
                                                ...
                                                <div class="gf_browser_chrome gform_wrapper" id="gform_wrapper_1">
                                                    <form action="#">
                                                        <div class="gform_heading">
                                                            <h3 class="gform_title">Contact Form Demo using Gravity Form </h3>
                                                            <span class="gform_description"></span>
                                                        </div>
                                                        <div class="gform_body">
                                                            <ul id="gform_fields_1" class="gform_fields top_label form_sublabel_below description_below">
                                                                <li id="field_1_3" class="gfield gfield_html gfield_html_formatted gfield_no_follows_desc field_sublabel_below field_description_below">This is a demo form using Gravity Forms for WordPress integrating with the user profile.</li>
                                                                <li id="field_1_1" class="gfield gfield_contains_required field_sublabel_below field_description_below">
                                                                    ...
                                                                    <div class="ginput_complex ginput_container no_prefix has_first_name no_middle_name has_last_name no_suffix" id="input_1_1">
                                                                        <span id="input_1_1_3_container" class="name_first">
                                                                            <input id="input_1_1_3" name="name" class="valid" type="text">
                                                                            <label for="input_1_1_3">First</label>
                                                                       </span>
                                                                        <span id="input_1_1_6_container" class="name_last">
                                                                            <input id="input_1_1_6" name="name" class="valid" type="text">
                                            ...
                                            <div id="tab-4" class="elp-author-video epl-author-tab-content epl-author-box author-box">
                                                <iframe src="https://player.vimeo.com/video/108832629" height="50px"></iframe>
                                            </div>            
                                        </div>
                                        <!-- end author box -->
                                    </div>
                        ...
                        <div class="comments-area" id="comments">
                            <div class="comment-respond" id="respond">
                                ...
                                <form action="#" id="commentform" class="comment-form">
                                    <p class="logged-in-as"><a href="#" aria-label="Logged in as kivv. Edit your profile.">Logged in as kivv</a>. <a href="#">Log out?</a>
                                    </p>
                                    <p class="comment-form-comment">
                                        <label>Comment</label>
                                        <textarea name="message" cols="30" rows="10" placeholder="Message*" value="Message*" onfocus="if(this.value=='Message*')this.value='';" onblur="if(this.value=='')this.value='Message*';" id="comment_phone" class="valid"></textarea>
                                    </p>
                                    <p class="form-submit">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <div class="real_sidebar_right">
                            ...
                            <aside id="epl_property_gallery-3" class="widget widget_epl_property_gallery"><h3 class="widget-title">Listing Photos In Widget</h3>
                                    <div class="gallery galleryid-114 gallery-columns-3 gallery-size-thumbnail">
                                        <div class="gallery-item">
                                            
                                                <a class="fancybox image" href="#">
                                                <img src="http://placehold.it/117x117" class="attachment-thumbnail" alt=""></a>
                            ...
                            <aside id="epl_author-2" class="widget widget_epl_author"><h3 class="widget-title">Current Author</h3>
                                <div class="epl-widget epl-author-card epl-author author-card author">
                                            <div class="entry-content">
                                                <div class="epl-author-box-tall epl-author-image author-box-tall author-image epl-clearfix">
                                                    <img alt="" src="http://placehold.it/370x234" class="avatar avatar-150 photo"> </div>
                                                <div class="epl-author-box-tall epl-author-details author-box-tall author-details epl-clearfix">
                                                    <h5 class="epl-author-title author-title"><a href="#">Agent Julia Robert</a></h5>
                                                    <div class="epl-author-position author-position">Real Estate Group</div>
                                                    <div class="epl-author-contact author-contact">
                                                        
                                                        <span class="mobile">44 (0) 800 765 1234</span>
                                                    </div>
                                                    <div class="epl-author-social-buttons author-social-buttons">
                                                        <a class="epl-author-icon author-icon email-icon-24" href="#">Contact Julia Robert by email</a>

                                                    </div>
                                                    <div class="epl-author-content author-content">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed vitae nisi eu felis viverra vulputate. Cras malesuada felis magna, sit amet vestibulum risus ultricies at. Nullam ultrices erat in mauris varius, ac dapibus ante bibendum. Sed rutrum neque id faucibus elementum...</div>
                            ...
                            <aside class="widget widget_epl_property_search real_style_03" id="epl_property_search-5">
                                <h3 class="widget-title">Listing Search Widget</h3>
                                ...
                                <div class="epl-search-forms-wrapper epl-search-default">
                                    <div class="epl-search-form epl-sb-current" id="epl_ps_tab_1">
                                        <form method="get" action="https://easypropertylistings.com.au/demo/">
                                            ...
                                            <div class="epl-search-row epl-search-land-area">
                                                <div class="epl-search-row epl-search-row-number epl-property_land_area_min fm-block epl-search-row-third">
                                                    <label for="property_land_area_min" class="epl-search-label fm-label">
                                                        Land Min </label>
                                                    <div class="field">
                                                        <input class="in-field field-width" name="property_land_area_min" id="property_land_area_min" value="" type="number">
                                                    </div>
                                                </div>
                                                <div class="epl-search-row epl-search-row-number epl-property_land_area_max fm-block epl-search-row-third">
                                                    <label for="property_land_area_max" class="epl-search-label fm-label">
                                                        Land Max </label>
                                                    <div class="field">
                                                        <input class="in-field field-width" name="property_land_area_max" id="property_land_area_max" value="" type="number">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="epl-search-row epl-search-building-area">
                                                <div class="epl-search-row epl-search-row-number epl-property_building_area_min fm-block epl-search-row-third">
                                                    <label class="epl-search-label fm-label">
                                                        Building Min </label>
                                                    <div class="field">
                                                        <input class="in-field field-width" name="property_building_area_min" value="" type="number">
                                                    </div>
                                                </div>
                                                <div class="epl-search-row epl-search-row-number epl-property_building_area_max fm-block epl-search-row-third">
                                                    <label class="epl-search-label fm-label">
                                                        Building Max </label>
                                                    <div class="field">
                                                        <input class="in-field field-width" name="property_building_area_max" value="" type="number">
                                                    </div>
                                                </div>
                                                <div class="epl-search-row epl-search-row-select epl-property_building_area_unit fm-block epl-search-row-third">
                                                    <label class="epl-search-label fm-label">
                                                        Area Unit </label>
                                                    <div class="field">
                                                        <select name="property_building_area_unit" class="in-field field-width">
                                                            <option value="">
                                                                Any </option>
                                                            <option value="square">Square</option>
                                                            <option value="squareMeter">Square Meter</option>
                                    ...
                                    <div class="epl-search-form " id="epl_ps_tab_2">
                                        <form method="get" action="https://easypropertylistings.com.au/demo/">
                                            <input name="action" value="epl_search" type="hidden">
                                            <input class="in-field field-width" name="post_type" value="land" type="hidden">
                                            <input class="in-field field-width" name="property_status" value="" type="hidden">
                                            <div class="epl-search-row epl-search-row-text epl-property_id fm-block epl-search-row-full">
                                                <label class="epl-search-label fm-label">
                                                    Search by Property ID / Address </label>
                                            ...
                                            <div class="epl-search-row epl-search-row-select epl-property_address_city fm-block epl-search-row-half">
                                                <label class="epl-search-label fm-label">
                                                    City </label>
                                                <div class="field">
                                                    <select name="property_address_city" class="in-field field-width">
                                                        <option value="">
                                                            Any </option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="epl-search-row epl-search-row-select epl-property_address_state fm-block epl-search-row-half">
                                                <label class="epl-search-label fm-label">
                                                    State </label>
                                                <div class="field">
                                                    <select name="property_address_state" class="in-field field-width">
                                                        <option value="">
                                                            Any </option>
                                            ...
                                            <div class="epl-search-row epl-search-row-select epl-property_address_postal_code fm-block epl-search-row-half">
                                                <label class="epl-search-label fm-label">
                                                    Post Code </label>
                                                <div class="field">
                                                    <select name="property_address_postal_code" class="in-field field-width">
                                                        <option value="">
                                                            Any </option>
                                            ...
                                            <div class="epl-search-row epl-search-row-select epl-property_address_country fm-block epl-search-row-half">
                                                <label class="epl-search-label fm-label">
                                                    Country </label>
                                                <div class="field">
                                                    <select name="property_address_country" class="in-field field-width">
                                                        <option value="">
                                                            Any </option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="epl-search-row epl-search-row-select epl-property_land_category fm-block epl-search-row-full">
                                                <label for="property_land_category" class="epl-search-label fm-label">
                                                    Land Category </label>
                                                <div class="field">
                                                    <select name="property_land_category" id="property_land_category" class="in-field field-width">
                                                        <option value="">
                                                            Any </option>
                                            ...
                                            <div class="epl-search-row epl-search-land-area">
                                                <div class="epl-search-row epl-search-row-number epl-property_land_area_min fm-block epl-search-row-third">
                                                    <label class="epl-search-label fm-label">
                                                        Land Min </label>
                                                    <div class="field">
                                                        <input class="in-field field-width" name="property_land_area_min" value="" type="number">
                                                    </div>
                                                </div>
                                                <div class="epl-search-row epl-search-row-number epl-property_land_area_max fm-block epl-search-row-third">
                                                    <label class="epl-search-label fm-label">
                                                        Land Max </label>
                                                    <div class="field">
                                                        <input class="in-field field-width" name="property_land_area_max" value="" type="number">
                                                    </div>
                                                </div>
                                                <div class="epl-search-row epl-search-row-select epl-property_land_area_unit fm-block epl-search-row-third">
                                                    <label class="epl-search-label fm-label">
                                                        Area Unit </label>
                                                    <div class="field">
                                                        <select name="property_land_area_unit" class="in-field field-width">
                                                            <option value="">
                                                                Any </option>
                                                            <option value="square">Square</option>
                                                            <option value="squareMeter">Square Meter</option>
                                    ...
                                    <div class="epl-search-form " id="epl_ps_tab_3">
                                        <form method="get" action="https://easypropertylistings.com.au/demo/">
                                            <input name="action" value="epl_search" type="hidden">
                                            <input class="in-field field-width" name="post_type" value="rental" type="hidden">
                                            <input class="in-field field-width" name="property_status" value="" type="hidden">
                                            <div class="epl-search-row epl-search-row-text epl-property_id fm-block epl-search-row-full">
                                                <label class="epl-search-label fm-label">
                                                    Search by Property ID / Address </label>
                            ...
                            <aside id="epl_recent_property-5" class="widget widget_epl_recent_property"><h3 class="widget-title">Listing Search Widget</h3><div class="epl-property-widget-image-wrapper">
                                <div class="epl-widget epl-listing-widget property-widget-image epl-widget-status-current">
                                    <div class="entry-header">
                                        <div class="epl-archive-entry-image">
                                            <a href="#">
                                                <div class="epl-blog-image">
                                                    <img src="http://placehold.it/370x234" class="teaser-left-thumb wp-post-image" alt="1024px-'Del_Osa'_9_Appian_Way-wide">
                                                </div>
                                            </a>
                                        </div>
                                        <div class="epl-inspection-times">
                                    ...
                                    <div class="entry-content">
                                                    <h5 class="property-heading"><a href="#">15421 Southwest 39th Terrace</a></h5>
                                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent consectetur dolor rutrum elit cursus viverra. Suspendisse mollis arcu nec tellus...     
                                       

                                                    <div class="property-meta property-feature-icons"><span title="Bedrooms" class="icon beds"><span class="icon-value">1</span></span><span title="Bathrooms" class="icon bath"><span class="icon-value">2</span></span><span title="Parking Spaces" class="icon parking"><span class="icon-value">6</span></span></div>
                                                
                                                    <div class="property-meta price"><span class="page-price"><span class="page-price-prefix">Under Offer</span> $3,850 </span></div>
